...
- Spacing and layout rhythm: the four-region cockpit matches the anchor at 1440x1024. The short-height desktop query fits the default 1320x860 window without enlarging it, with approximately eight visible workload rows in the deterministic fixture.
...
- 1280x900: short-height desktop mode, 56px workload rows, readable identity, no overflow.
